"""
Django settings for delicate_block_24 project.
...
ROOT_URLCONF = 'delicate_block_24.urls'
...
WSGI_APPLICATION = 'delicate_block_24.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_block_24 API",
    "DESCRIPTION": "API documentation for delicate_block_24 App",
    "VERSION": "v1",
}
